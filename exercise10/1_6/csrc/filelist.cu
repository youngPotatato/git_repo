...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _17096_archive_1.so
_17096_archive_1.so : archive.5/_17096_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -m elf_i386 -shared  -o .//../simv.daidir//_17096_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_17096_archive_1.so $@
